...
CU = 3          PU = 2 <br>
CU<sub>c</sub> = 3  <br>
PU<sub>c</sub> = 2 <br>CU<sub>c</sub>, and CU<sub>c</sub> were found in the following tests: <br>(intersectsRangeFullyOverlapsSpecifiedRange, and            intersectsRangePartiallyOverlapingSpecifiedRange) <br>
There were no infeasible cases so coverage is found by: <br>
(2+3)/(2+3) = 100%
...
PU<sub>f</sub> = 4 <br>
CU<sub>c</sub> = 8  <br>
PU<sub>c</sub> = 5 <br>CU<sub>c</sub>, and CU<sub>c</sub> were found in the following tests: <br>(calculateColumnTotalForTwoValues,            calculateColumnTotalReturnsZeroForInvalidValue, and calculateColumnTotalReturnsZeroForEmptyValue2D) <br>
